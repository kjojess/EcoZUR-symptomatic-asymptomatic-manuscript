...
phy_Uninf_inext_out<-iNEXT(phy_Uninf_inext, q=0, datatype="abundance")
...
#by DEC infection status
phy_Ec_removed_Inf_inext_out<-iNEXT(phy_Ec_removed_Inf_inext, q=0, datatype="abundance")
phy_Ec_removed_Uninf_inext_out<-iNEXT(phy_Ec_removed_Uninf_inext, q=0, datatype="abundance")
